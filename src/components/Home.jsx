...
function Home({ checked, setChecked }) {
        ...
        <div className="inner-display ">
          ...
          <div className="product-content">
            <div className="content-container">
              ...
              <a className="view-menu-btn" href="/">
                VIEW MENU <i class="ico-arrows menu-arrow"></i>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="footer-container">
          <div className="footer-inner">
            <div className="footer-left">
              ...
              <div className="footer-socials">
                <ul>
                  ...
                  <li>
                    <i className="footer-instagram"></i>
                  </li>
                  <li>
              ...
              <ul className="footer-links">
                <li className="small-footerLink">
                  SITE DESIGNED BY ALGO+RHYTHM{" "}
                </li>
            ...
            <div className="footer-right">
              <a
                onMouseOver={() => setBackToTop(true)}
                onMouseLeave={() => setBackToTop(false)}
                href="#Home"
                className={
                  backToTop
                    ? "animate__animated animate__tada back-to-top-container"
