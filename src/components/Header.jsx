...
function Header({ checked, setChecked }) {
  ...
  return (
    <header className="Header">
      ...
      <div
        id={navScroll ? "navBar-scroll" : "navBar-noScroll"}
      ...
      >
        <div className="bottom-header-items">
          <a href="#Home" className="main-logo">
            <img
              className={navScroll ? "logo logo-onScroll" : "logo"}
              src={logo}
              alt="logo"
            ></img>
          </a>
          ...
          <div className="mobile-rightSide">
            ...
            <div
              id={
                navScroll
                  ? "navBar-scroll-location"
                  : "navBar-noScroll-location"
              }
              className="locations-hover-container"
            >
              <label className="location-button" htmlFor="locationBtn">
                <i class="fa-solid fa-location-dot locationLogo"></i>
              </label>

              <div
                onMouseOver={() => setLocationChecked(true)}
                onMouseLeave={() => setLocationChecked(false)}
              >
                <div className=" hiddenMobile location-label-container">
                  <h3 className="locations-label">LOCATIONS</h3>
                  <i
                    onClick={handleButtonClick}
                    class="down-arrow fa-solid fa-sort-down"
                  ></i>
                </div>
                ...
                <ul
                  id={
                    locationChecked ? "location-pressed" : "location-notPressed"
                  }
                  className={navScroll ? "navBar-scroll-slide slide" : "slide"}
                >
                  ...
                  <div className="slide-container">
                    ...
                    <h4 className="current-location">
                      <span>
                        <i class="fa-solid fa-location-arrow location-arrow"></i>
                      </span>
            ...
            <div className="hamburger-menu">
              ...
              <button
                id={navScroll ? "navBar-btn-scroll" : "navBar-btn-noScroll"}
              ...
              <ul className="menu__box">
                <li>
                  <a
                    ...
                    href="#"
                  >
                    MENU <i class="fa-solid fa-greater-than more-menu"></i>
                  </a>
                </li>
                {/* SIDE MENU DROPDOWN */}
                <div
                  id={menuSideOpen ? "menu-side-open" : "menu-side-closed"}
                ...
                >
                  ...
                  <ul className="side-list-menu">
                    ...
                    <li className="side-menu-list individual">
                      <a href="#">
                        <figure>
            ...
            <ul className="navList">
              ...
              >
                ...
                <div
                  onMouseOver={() => setMenuOpen(true)}
                  onMouseLeave={() => setMenuOpen(false)}
                  id={menuOpen ? "menu-open" : "menu-notOpen"}
