      ...
      <section className="social-section">
        <div className="social-container">
          <div className="social-inner">
            <div className="social-content animate__animated animate__slideInLeft">
              <h2 className="social-title">
                BECOME A ROSA'S <span className="social-star">VIP</span>
              </h2>
              <p>
            ...
            <div
              className={
                "social-content content-left animate__animated animate__slideInRight"
              }
            >
              <h2>PURCHASE A GIFT CARD</h2>
              <figure className="social-card">
                <img
                  width="350px"
        ...
        <div className="socialMedia-container">
          <div className="socialMedia-section-inner">
            <div className="socials">
              <ul className="animate__animated animate__tada">
                <li>
                  <span>
      ...
      <section className="event-section">
        <div className="event-container">
          <div className="event-inner">
            <figure className="animate__animated animate__slideInLeft event-img">
              <img src={event} alt="dinner plate" />
            </figure>

            <div className="animate__animated animate__slideInRight event-content">
